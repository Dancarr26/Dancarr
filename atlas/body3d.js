...
window.Body3D={
 ...
 visible(){if(!this.structs)return [];const z=this.zone||0;return this.structs.filter(s=>this.layers[s.layer]&&(!z||(s.zones&(1<<z)))&&(!this.focusSet||this.focusSet.has(s.id)));},
